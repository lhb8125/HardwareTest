...
#-------------------------------OUTPUT GPU-------------------------------#
    ...
    gpu_mem_bus = "memory bus width," + concatelist(memory_bus_w)
    fout.write(gpu_mem_bus)
    gpu_single_flops = "GFLOPS(single float)," + concatelist(single_f)
    fout.write(gpu_single_flops)
    gpu_d2d = "gpu memory bandwidth(MB/s)," + concatelist(d2d)
    fout.write(gpu_d2d)
    gpu_h2d = "gpu host2device bandwidth(MB/s)," + concatelist(h2d)
    fout.write(gpu_h2d)
    gpu_d2h = "gpu device2host bandwidth(MB/s)," + concatelist(d2h)
    fout.write(gpu_d2h)
#-------------------------------OUTPUT GPU END-------------------------------#
